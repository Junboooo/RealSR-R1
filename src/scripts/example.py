...
export DATA_PATH=/work/docker/GRPO/grpo-lumina/src/virft/src/open_r1/500_v2
export CKPT_PATH=/work/docker/GRPO/grpo-lumina/share_models/RealSR-R1/checkpoint
