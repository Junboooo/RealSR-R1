            ...
            if self.num_image_start_tokens == self.num_image_end_tokens:
                ...
                if new_token_num >= 2:
                    ...
                    if (len(tokens) + 1) % (self.states[i]['w_latent_dim'] + 1) == 0:
                        ...
                        all_scores.append(new_line_constrained_scores) 
                        ...
                        all_scores.append(eos_image_constrained_scores)  
                        print("end_image")
                        continue
                        ...
                        all_scores.append(image_constrained_scores) 
                        continue
                else:
                    all_scores.append(scores_i)
                    continue
...
class InterleavedTopKLogitsWarper(): #LogitsWarper
    ...
    def _plot_entropy_heatmap(self, output_path=None):
        ...
        entropy_map = np.array(self.image_entropies).reshape(h, w)[:, :-1]  
